...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link" href="../Global/message.php" id="curr">Messages</a>
...
<div class="text-center">
  ...
  <div class="col">
    <label>Heading
    <input type="text" name= "Heading" class="form-control"  value = "<?php echo $res["Heading"]?>"> </input>
  </div>
  <div class="col">
    <label>Message
    <input type="text" name= "Message" class="form-control"  value = "<?php echo $res['Message']?>"> </input>
  </div>
  <br>
