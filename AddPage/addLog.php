...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link" href="../Global/diary.php" id = "curr">Diary > Add Diary</a>
...
<div class="text-center">
  ...
  <form action = "addLogCode.php" method = "post">
    ...
    <h3><label for="exampleFormControlInput1" class="bonochi">Date</label></h3>
      <input name = "Date" class="form-control" id="exampleFormControlInput1"  placeholder="Dare here"   required> 
    </div>
    <div class="form-group">
